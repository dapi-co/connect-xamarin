...
namespace NativeLibrary
{
	...
	interface DPCPayment
	{
		...
		void GetBeneficiaries([NullAllowed] Action<DPCBeneficiary[], NSError, NSString> completion);
	...
	interface DPCData
	{
		...
		[Export("getAccounts:")]
		void GetAccounts([NullAllowed] Action<DPCAccount[], NSError, NSString> completion);
		...
		void GetTransactionsForAccountID(string accountID, NSDate fromDate, NSDate toDate, [NullAllowed] Action<DPCTransaction[], NSError, NSString> completion);
	}
